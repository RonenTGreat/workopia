<x-layout>
    ...
    <div
        ...
        <form
            ...
            <x-inputs.text-area id="requiremnts" name="requirements" label="Requirements" placeholder="Bachelor's degree in Computer Science" />
            ...
            <x-inputs.text id="company_website" name="company_website" type="url" label="Enter Company Website" placeholder="Enter website" />

            <x-inputs.text id="contact_phone" name="contact_phone" label="Contact Phone" placeholder="Enter Contact Phone" />

            <x-inputs.text id="contact-email" type="email" name="contact_email" label="Contact Email" placeholder="Enter Contact Email" />
