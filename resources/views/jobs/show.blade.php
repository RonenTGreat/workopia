    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <div x-cloak x-show="open" class="fixed inset-0 flex items-center justify-center bg-gray-900/50">
                        <div @click.away="open = false" class="bg-white p-6 rounded-lg shadow-md w-full max-w-md">
                            ...
                            <form method="POST" action="{{ route('applicant.store', $job->id) }}" enctype="multipart/form-data">
                                ...
                                <button  type="submit" class="bg-blue-500 hover:bg-blue-400 text-white px-4 py-2 rounded-md">Submit Application</button>
        ...
        <aside class="bg-white rounded-lg shadow-md p-3">
            ...
            <a
                ...
                target="_blank"
                class="text-blue-500">Visit Website</a>
            @endif
            ...
            @else
            <form class="mt-10" method="POST" action="{{ auth()->user()->bookmarkedJobs()->where('job_id', $job->id)->exists() ? route('bookmarks.destroy', $job->id) : route('bookmarks.store', $job->id)  }}">
                @csrf
