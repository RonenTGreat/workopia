...
<div class="rounded-lg shadow-md bg-white p-4">
    ...
    <ul class="my-4 bg-gray-100 p-4 rounded">
        ...
        <li class="mb-2">
            ...
            @if ($job->remote)
            <span
                class="text-xs bg-green-500 text-white rounded-full px-2 py-1 ml-2">Remote</span>
            @else
            <span
                class="text-xs bg-red-500 text-white rounded-full px-2 py-1 ml-2">On-site</span>
            @endif
        </li>
        @if ($job->tags)
        <li class="mb-2">
